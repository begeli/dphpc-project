...
data = pd.read_csv('tensor-contraction/code/weak_scaling_mmm.csv', delimiter=';')
...
plt.grid(axis='y')
bolded_string = r"$\bf{MMM}$ $\bf{(processors}$ $\bf{=}$ $\bf{1000)}$"
...
print(list(range(0, int(max(actual) * 1.2), 1000000000)))
...
plt.yticks(range(0, int(max(actual) * 1.2), 1000000000), ['0.0', '1.0×10⁹', '2.0×10⁹', '3.0×10⁹', '4.0×10⁹', '5.0×10⁹', '6.0×10⁹', '7.0×10⁹', '8.0×10⁹', '9.0×10⁹', '10.0×10⁹', '11.0×10⁹', '12.0×10⁹', '13.0×10⁹', '14.0×10⁹', '15.0×10⁹'], fontsize=25)
figure = plt.gcf()
figure.set_size_inches(12 * 1.3, 9 * 1.6)
plt.savefig('weak_scaling_mmm.pdf')
plt.close()